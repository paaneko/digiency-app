...
export function OurServices({ img, label, titles, description }: HomeServicesType) {
  return (
    <div className="my-[15px]">
      <div className="rounded-md cursor-pointer w-[325px] h-[290px] xl:w-[370px] xl:h-[290px]  flex-col shadow-div text-gray-pg hover:bg-orange-main hover:text-white duration-500">
